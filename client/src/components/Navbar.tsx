  ...
  return (
    <nav className="bg-[#111111] text-[#E5E5E5] px-6 py-3 flex items-center justify-between border-b border-[#2A2A2A]">
      ...
      <form onSubmit={handleSearch} className="mx-6 flex justify-center flex-1">
        ...
        />
        <button className="ml-2 px-3 py-2 rounded-md bg-[#2ACFCF] text-[#111111] hover:bg-[#26BABA] transition-colors duration-300 cursor-pointer">
      ...
      <div className="flex items-center space-x-4 ">
        ...
        {/* Profile icon */}
        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#2ACFCF] cursor-pointer">
          <img
